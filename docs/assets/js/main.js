...
(function () {
  ...
  const s = typeof Symbol !== 'undefined' ? Symbol.prototype : null
  const u = e.push
  const c = e.slice
  const p = o.toString
  ...
  function F (i) {
    return function (n, r, t) {
      r = d(r, t)
      for (let e = A(n), u = i > 0 ? 0 : e - 1; u >= 0 && u < e; u += i) {
  ...
  (h.memoize = function (e, u) {
    var i = function (n) {
      const r = i.cache
      const t = '' + (u ? u.apply(this, arguments) : n)
  ...
  function B (n, r) {
    ...
    const u = (h.isFunction(e) && e.prototype) || o
    let i = 'constructor'
    for (j(n, i) && !h.contains(r, i) && r.push(i); t--;) {
      (i = T[t]) in n && n[i] !== u[i] && !h.contains(r, i) && r.push(i)
    }
  }
  const I = !{ toString: null }.propertyIsEnumerable('toString')
  var T = [
    'valueOf',
    'isPrototypeOf',
    'toString',
...
(function (t) {
  ...
  (a.listenTo = function (t, e, n) {
    if (!t) return this
    const r = t._listenId || (t._listenId = i.uniqueId('l'))
    const s = this._listeningTo || (this._listeningTo = {})
    let a = (h = s[r])
    a ||
  ...
  (a.once = function (t, e, i) {
    ...
    return (
      typeof t === 'string' && i == null && (e = void 0), this.on(n, e, i)
    )
  }),
  ...
  i.extend(m.prototype, a, {
    ...
    set: function (t, e, n) {
      ...
      const c = this._previousAttributes
      for (const f in r) {
        (e = r[f]),
    ...
    changedAttributes: function (t) {
      ...
      let r
      const e = this._changing ? this._previousAttributes : this.attributes
      const n = {}
      for (const s in t) {
        const a = t[s]
  ...
  const y = { add: !0, remove: !0, merge: !0 }
  const b = { add: !0, remove: !1 }
  i.extend(_.prototype, a, {
    ...
    set: function (t, e) {
      if (t != null) {
        ...
        const f = e.remove
        let d = !1
        const v = this.comparator && r == null && !1 !== e.sort
        const p = i.isString(this.comparator) ? this.comparator : null
    ...
    _onModelEvent: function (t, e, i, n) {
      if (e) {
        ...
        if ((t === 'destroy' && this.remove(e, n), t === 'change')) {
          ...
          const s = this.modelId(e.attributes)
          r !== s &&
  ...
  const w = typeof Symbol === 'function' && Symbol.iterator
  ...
  (E.prototype.next = function () {
    if (this._collection) {
      if (this._index < this._collection.length) {
        let e
        const t = this._collection.at(this._index)
  ...
  i.extend(B.prototype, a, {
    ...
    start: function (t) {
      ...
      if (
        ...
        const r = n.insertBefore(this.iframe, n.firstChild).contentWindow
        r.document.open(),
        r.document.close(),
...
(function () {
  ...
  (e.stemmer = (function () {
    ...
    const f = new RegExp('^([^aeiou][^aeiouy]*)?[aeiouy]')
    const p = /^(.+?)(ss|i)es$/
    const y = /^(.+?)([^s])s$/
    const m = /^(.+?)eed$/
    const v = /^(.+?)(ed|ing)$/
    ...
    const I = function (r) {
      ...
      if (
        ((s = r.substr(0, 1)) == 'y' && (r = s.toUpperCase() + r.substr(1)),
        (a = y),
        (o = p).test(r)
          ? (r = r.replace(o, '$1$2'))
      ...
      if (typedoc.isPointerDown && !typedoc.hasPointerMoved) {
        const t =
              typedoc.pointerDown == 'touchstart'
                ? e.originalEvent.targetTouches[0]
                : e
        const x = typedoc.pointerDownPosition.x - (t.pageX || 0)
        const y = typedoc.pointerDownPosition.y - (t.pageY || 0)
...
(function (typedoc) {
  ...
  const FilterItemCheckbox = (function (_super) {
  ...
  const FilterItemSelect = (function (_super) {
  ...
  const MenuHighlight = (function (_super) {
    ...
    return (
      ...
      (MenuHighlight.prototype.createAnchors = function () {
        ...
        base.indexOf('#') != -1 && (base = base.substr(0, base.indexOf('#'))),
...
(function (typedoc) {
  ...
  !(function (search) {
    ...
    const $el = $('#tsd-search')
    const $field = $('#tsd-search-field')
    const $results = $('.results')
    const base = $el.attr('data-base') + '/'
    let query = ''
    let loadingState = SearchLoadingState.Idle
    let hasFocus = !1
    let preventPress = !1
    let index
    let resultClicked = !1
    ...
    function updateResults () {
      if (
        ...
        for (let i = 0, c = Math.min(10, res.length); i < c; i++) {
          const row = search.data.rows[Number(res[i].ref)]
...
(function (typedoc) {
  ...
  const Signature = (function (_super) {
